##Create form lines of depressions=name
##contoursofdepression=vector
##dem=raster
##formlinesdepression=output vector
...
outputs_QGISEXTRACTBYATTRIBUTE_4=processing.runalg('qgis:extractbyattribute', outputs_QGISEXTRACTBYATTRIBUTE_5['OUTPUT'],'area',3,'137',None)
...
outputs_QGISDELETECOLUMN_1=processing.runalg('qgis:deletecolumn', outputs_QGISEXTRACTBYATTRIBUTE_1['OUTPUT'],'length',formlinesdepression)